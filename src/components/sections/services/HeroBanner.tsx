...
const HERO_BG =
  "https://images.ctfassets.net/pj0maraabon4/6FpFxRCtxuuGQmQyIX0N8i/60c86ad2f47d442a480334c691de7d70/services-main-img.png";
         ...
         SERVICES
          ...
          <motion.h1
            ...
            className="text-white font-semibold lg:leading-tight
              ...
              lg:text-5xl"
          >
           DLUX-ify Your MarTech Game! Simplify. Automate. Suceed
          </motion.h1>
          <AnimatedDivider/>
        </div>
      </div>
